...
namespace CN.STOCK.DynamicOData.Extensions
{
    ...
    {
        public static ODataRoute CustomMapODataServiceRoute(this IRouteBuilder routeBuilder, string routeName, string routePrefix, string controller = null)
        {
            ODataRoute route = routeBuilder.MapODataServiceRoute(routeName, routePrefix, builder =>
            {
                ...
                builder.AddService(ServiceLifetime.Singleton, sp =>
                {
                    ...
                    routingConventions.Insert(0, new MatchAllRoutingConvention(controller));
